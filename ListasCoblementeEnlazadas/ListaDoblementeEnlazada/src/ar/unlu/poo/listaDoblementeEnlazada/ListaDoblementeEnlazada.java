...
public class ListaDoblementeEnlazada {
    ...
    public Nodo iteradorDelante(Nodo nodo){
    ...
    public Nodo iteradorAtras(Nodo nodo){
        if (nodo.getAnterior()!=null){
            nodo=nodo.getAnterior();
            return nodo;
        }
        else {
            System.out.printf("Se encuentra en el primer elemento de la lista.\n");
            return null;
        }
    }
    ...
    public Object buscar(Object elemento){
        Integer econtrado=0;
        Nodo nodoAux=primero;
        while (nodoAux.getDato()!=elemento && nodoAux.getProximo()!=null){
            nodoAux=nodoAux.getProximo();
        }
        if (nodoAux.getDato()==elemento){
